    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sellers', models.ManyToManyField(related_name='orders', to='accounts.sellerprofile')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='accounts.sellerprofile')),
            ],
        ),
    ]
